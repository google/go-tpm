...
func (list *TPMLDigest) String() string {
	var s strings.Builder
	s.WriteString("TPMLDigest{")
	for iterator, item := range list.Digests {
		s.WriteString("Digest")
		s.WriteString(string(iterator) + "{")
...
// DecodeTPMLDigest decodes a TPML_Digest part of a message. No error is returned if
// the input has extra trailing data.
