...
const (
	...
	TPMAlgSHA256_192   TPMAlgID = 0x000E
	...
	TPMAlgSHAKE256_192 TPMAlgID = 0x002C
	TPMAlgSHAKE256_256 TPMAlgID = 0x002D
	TPMAlgSHAKE256_512 TPMAlgID = 0x002E
	...
	TPMAlgEDDSA_PH     TPMAlgID = 0x0061
...
const (
	...
	TPMECCBP_P256_R1  TPMECCCurve = 0x0030
	TPMECCBP_P384_R1  TPMECCCurve = 0x0031
	TPMECCBP_P512_R1  TPMECCCurve = 0x0032
	TPMECCCurve_25519 TPMECCCurve = 0x0040
	TPMECCCurve_448   TPMECCCurve = 0x0041
)
