...
func TestSignEncode(t *testing.T) {
	...
	t.Run("AlgSHA256", func(t *testing.T) {
		// TODO: this test string generated by own test. please see https://www.trustedcomputinggroup.org/wp-content/uploads/TPM-Rev-2.0-Part-3-Commands-01.38.pdf 20.2.2 Command and Respons.
